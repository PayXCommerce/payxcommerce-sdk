...
class Payxcommerce extends \Opencart\System\Engine\Controller
{
    ...
    public function confirm(): void
    {
        ...
        try {
            ...
            $client = new \Opencart\System\Library\Payxcommerce($this->settings());
        ...
        $this->model_checkout_order->addHistory($order_id, (int) $this->config->get('payment_payxcommerce_pending_status_id'), $this->brandName() . ' checkout created.', true);
    ...
    public function webhook(): void
    {
        ...
        try {
            require_once DIR_EXTENSION . 'payxcommerce/system/library/payxcommerce.php';
            $payload = (new \Opencart\System\Library\Payxcommerce($this->settings()))->verifyWebhook($raw_body, $this->request->server);
        } catch (\Throwable $exception) {
            $this->log->write('PayXCommerce webhook verification failed: ' . $this->redact($exception->getMessage()));
        ...
        try {
            ...
            $this->model_extension_payxcommerce_payment_payxcommerce->completeWebhookEvent($event_id, 'failed', $exception->getMessage());
    ...
    {
        require_once DIR_EXTENSION . 'payxcommerce/system/library/payxcommerce.php';
        return \Opencart\System\Library\Payxcommerce::redact($message);
    }
}
